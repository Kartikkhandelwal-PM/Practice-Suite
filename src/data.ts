...
export const INIT_CLIENTS: Client[] = [
  { id: 'c1', name: 'Agarwal Exports Pvt Ltd', pan: 'AAGCA1234F', gstin: '29AAGCA1234F1Z5', category: 'Pvt Ltd', services: ['GST', 'Audit', 'ITR', 'TDS'], manager: 'u2', email: 'ramesh@agarwalexports.in', phone: '9876543210', address: 'HSR Layout, Bengaluru - 560102', onboarded: '2021-04-01', active: true },
  { id: 'c2', name: 'Mehta Industries', pan: 'AAAFM4567G', gstin: '27AAAFM4567G1ZA', category: 'Partnership', services: ['GST', 'TDS'], manager: 'u3', email: 'info@mehtaind.in', phone: '9845012345', address: 'Andheri East, Mumbai - 400069', onboarded: '2020-07-15', active: true },
  { id: 'c3', name: 'Sharma & Sons', pan: 'AAEFS9801H', gstin: '07AAEFS9801H1Z2', category: 'Proprietorship', services: ['Audit', 'ITR'], manager: 'u1', email: 'ceo@sharmasons.in', phone: '9711234567', address: 'Connaught Place, New Delhi - 110001', onboarded: '2019-03-10', active: true },
  { id: 'c4', name: 'Patel Constructions Pvt Ltd', pan: 'AAKFP2344J', gstin: '24AAKFP2344J1ZB', category: 'Pvt Ltd', services: ['ROC', 'TDS', 'GST'], manager: 'u2', email: 'admin@patelconstructions.in', phone: '9512345678', address: 'Navrangpura, Ahmedabad - 380009', onboarded: '2022-01-20', active: true },
  { id: 'c5', name: 'Verma Pharmaceuticals', pan: 'AAFPV6712K', gstin: '09AAFPV6712K1ZC', category: 'Pvt Ltd', services: ['GST', 'Audit', 'ROC', 'ITR'], manager: 'u3', email: 'accounts@vermapharma.com', phone: '9412345678', address: 'Gomti Nagar, Lucknow - 226010', onboarded: '2023-06-01', active: true },
  { id: 'c6', name: 'Sunita Textiles LLP', pan: 'AAQFS3388L', gstin: '29AAQFS3388L1ZD', category: 'LLP', services: ['GST', 'TDS', 'ITR'], manager: 'u2', email: 'accounts@sunitatex.in', phone: '9632145678', address: 'Ring Road, Surat - 395007', onboarded: '2021-11-14', active: true },
  { id: 'c7', name: 'Kapoor & Associates', pan: 'AABFK7890M', gstin: '06AABFK7890M1ZE', category: 'Partnership', services: ['ITR', 'Audit'], manager: 'u1', email: 'kapoor.assoc@gmail.com', phone: '9871234560', address: 'Sector 18, Gurugram - 122015', onboarded: '2020-09-01', active: true },
  { id: 'c8', name: 'Raghunath Steel Works', pan: 'AACFR4521N', gstin: '33AACFR4521N1ZF', category: 'Pvt Ltd', services: ['GST', 'TDS', 'Audit', 'ROC', 'ITR'], manager: 'u3', email: 'accounts@raghunathsteel.in', phone: '9344512345', address: 'Ambattur Industrial Estate, Chennai - 600058', onboarded: '2022-08-30', active: true },
];

export const INIT_USERS: User[] = [
  { id: 'u1', name: 'Rajesh Sharma', email: 'rajesh@kdkfirm.in', role: 'Admin', designation: 'Partner', color: '#2563eb', active: true },
  { id: 'u2', name: 'Priya Nair', email: 'priya@kdkfirm.in', role: 'Manager', designation: 'Senior Manager', color: '#dc2626', active: true },
  { id: 'u3', name: 'Amit Kulkarni', email: 'amit@kdkfirm.in', role: 'Manager', designation: 'Senior Accountant', color: '#059669', active: true },
  { id: 'u4', name: 'Sneha Reddy', email: 'sneha@kdkfirm.in', role: 'Staff', designation: 'Accountant', color: '#7c3aed', active: true },
  { id: 'u5', name: 'Rahul Joshi', email: 'rahul@kdkfirm.in', role: 'Article Clerk', designation: 'Article Clerk', color: '#d97706', active: true },
];

export const INIT_TASKS: Task[] = [
  { id: 'KDK-1', title: 'GSTR-3B Filing — October 2024', clientId: 'c1', type: 'GST', status: 'In Progress', priority: 'High', assigneeId: 'u2', reviewerId: 'u1', dueDate: fmt(subDays(today, 2)), createdAt: fmt(subDays(today, 19)), recurring: 'Monthly', description: 'File GSTR-3B for Agarwal Exports for October 2024. ITC claim pending verification.', tags: ['urgent', 'filing'], subtasks: [], comments: [{ id: 'cm1', userId: 'u2', text: 'Bank statement received. Starting GSTR-2B reconciliation.', createdAt: fmt(today) }, { id: 'cm2', userId: 'u1', text: 'This is overdue! Penalty accruing. File today.', createdAt: fmt(subDays(today, 1)) }], attachments: [{ id: 'a1', name: 'Oct_Invoices.pdf', size: '2.1 MB', type: 'pdf' }, { id: 'a2', name: 'Bank_Statement.xlsx', size: '340 KB', type: 'xlsx' }], activity: [{ text: 'Moved to In Progress by Priya', at: fmt(today) }, { text: 'Auto-escalated (overdue)', at: fmt(today) }, { text: 'Created by Rajesh', at: fmt(subDays(today, 19)) }] },
  { id: 'KDK-2', parentId: 'KDK-1', issueType: 'Subtask', title: 'Collect purchase invoices', clientId: 'c1', type: 'GST', status: 'Completed', priority: 'Medium', assigneeId: 'u2', reviewerId: 'u1', dueDate: fmt(subDays(today, 5)), createdAt: fmt(subDays(today, 19)), recurring: 'One-time', description: '', tags: [], subtasks: [], comments: [], attachments: [], activity: [] },
  { id: 'KDK-3', parentId: 'KDK-1', issueType: 'Subtask', title: 'Obtain bank statement', clientId: 'c1', type: 'GST', status: 'Completed', priority: 'Medium', assigneeId: 'u2', reviewerId: 'u1', dueDate: fmt(subDays(today, 4)), createdAt: fmt(subDays(today, 19)), recurring: 'One-time', description: '', tags: [], subtasks: [], comments: [], attachments: [], activity: [] },
  { id: 'KDK-4', parentId: 'KDK-1', issueType: 'Subtask', title: 'Reconcile GSTR-2B vs books', clientId: 'c1', type: 'GST', status: 'In Progress', priority: 'High', assigneeId: 'u2', reviewerId: 'u1', dueDate: fmt(today), createdAt: fmt(subDays(today, 19)), recurring: 'One-time', description: '', tags: [], subtasks: [], comments: [], attachments: [], activity: [] },
  { id: 'KDK-5', title: 'TDS Return Q2 — 26Q Filing', clientId: 'c2', type: 'TDS', status: 'In Progress', priority: 'High', assigneeId: 'u3', reviewerId: 'u1', dueDate: fmt(addDays(today, 8)), createdAt: fmt(subDays(today, 10)), recurring: 'Quarterly', description: 'Prepare and file Form 26Q for Q2 for Mehta Industries.', tags: ['tds', 'quarterly'], subtasks: [], comments: [{ id: 'cm1', userId: 'u3', text: 'Salary data received. Preparing return now.', createdAt: fmt(subDays(today, 1)) }], attachments: [], activity: [{ text: 'Amit started work', at: fmt(subDays(today, 2)) }] },
  { id: 'KDK-6', title: 'Balance Sheet Preparation FY 2023-24', clientId: 'c3', type: 'Audit', status: 'Under Review', priority: 'Medium', assigneeId: 'u4', reviewerId: 'u2', dueDate: fmt(addDays(today, 25)), createdAt: fmt(subDays(today, 30)), recurring: 'Annual', description: 'Prepare balance sheet and P&L for Sharma & Sons.', tags: ['audit', 'annual'], subtasks: [], comments: [], attachments: [{ id: 'a1', name: 'Trial_Balance.xlsx', size: '180 KB', type: 'xlsx' }], activity: [{ text: 'Sneha submitted for review', at: fmt(subDays(today, 1)) }] },
  { id: 'KDK-7', title: 'ROC Annual Return MGT-7', clientId: 'c4', type: 'ROC', status: 'Completed', priority: 'Low', assigneeId: 'u2', reviewerId: 'u1', dueDate: fmt(subDays(today, 5)), createdAt: fmt(subDays(today, 25)), recurring: 'Annual', description: 'File MGT-7 annual return for Patel Constructions on MCA portal.', tags: ['roc', 'completed'], subtasks: [], comments: [{ id: 'cm1', userId: 'u2', text: 'Filed successfully. Challan receipt saved.', createdAt: fmt(subDays(today, 5)) }], attachments: [{ id: 'a1', name: 'MGT7_Filed.pdf', size: '520 KB', type: 'pdf' }], activity: [{ text: 'Task completed', at: fmt(subDays(today, 5)) }] },
  { id: 'KDK-8', title: 'ITR Filing — AY 2024-25', clientId: 'c5', type: 'ITR', status: 'To Do', priority: 'Medium', assigneeId: 'u3', reviewerId: 'u1', dueDate: fmt(addDays(today, 41)), createdAt: fmt(subDays(today, 5)), recurring: 'Annual', description: 'Prepare and file Income Tax Return for Verma Pharmaceuticals.', tags: ['itr', 'annual'], subtasks: [], comments: [], attachments: [], activity: [{ text: 'Task created from template', at: fmt(subDays(today, 5)) }] },
  { id: 'KDK-9', title: 'GSTR-1 November — Outward Supplies', clientId: 'c6', type: 'GST', status: 'To Do', priority: 'High', assigneeId: 'u4', reviewerId: 'u2', dueDate: fmt(addDays(today, 21)), createdAt: fmt(subDays(today, 3)), recurring: 'Monthly', description: 'File GSTR-1 for Sunita Textiles LLP for November 2024.', tags: ['gst', 'monthly'], subtasks: [], comments: [], attachments: [], activity: [{ text: 'Task auto-created (recurring)', at: fmt(subDays(today, 3)) }] },
  { id: 'KDK-10', title: 'Advance Tax Q3 Computation', clientId: 'c2', type: 'Advance Tax', status: 'To Do', priority: 'Medium', assigneeId: 'u5', reviewerId: 'u3', dueDate: fmt(addDays(today, 25)), createdAt: fmt(subDays(today, 2)), recurring: 'Quarterly', description: 'Compute Q3 advance tax liability for Mehta Industries.', tags: ['advance-tax'], subtasks: [], comments: [], attachments: [], activity: [{ text: 'Task created', at: fmt(subDays(today, 2)) }] },
  { id: 'KDK-11', title: 'GST Reconciliation — GSTR-2B vs Books', clientId: 'c1', type: 'GST', status: 'Awaiting Info', priority: 'Medium', assigneeId: 'u4', reviewerId: 'u2', dueDate: fmt(addDays(today, 15)), createdAt: fmt(subDays(today, 8)), recurring: 'Monthly', description: 'Reconcile GSTR-2B auto-drafted ITC with purchase books for Agarwal Exports.', tags: ['reconciliation'], subtasks: [], comments: [{ id: 'cm1', userId: 'u4', text: 'Pending 5 invoices from client. Sent reminder.', createdAt: fmt(subDays(today, 1)) }], attachments: [], activity: [{ text: 'Status changed to Awaiting Info', at: fmt(subDays(today, 1)) }] },
  { id: 'KDK-12', title: 'Statutory Audit FY 2023-24', clientId: 'c8', type: 'Audit', status: 'In Progress', priority: 'High', assigneeId: 'u3', reviewerId: 'u1', dueDate: fmt(addDays(today, 35)), createdAt: fmt(subDays(today, 45)), recurring: 'Annual', description: 'Full statutory audit for Raghunath Steel Works FY 2023-24.', tags: ['audit', 'statutory'], subtasks: [], comments: [], attachments: [{ id: 'a1', name: 'Audit_Plan.pdf', size: '890 KB', type: 'pdf' }], activity: [{ text: 'Audit commenced', at: fmt(subDays(today, 10)) }] },
];
